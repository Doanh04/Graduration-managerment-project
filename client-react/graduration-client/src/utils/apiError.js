const messagesByCode = {
  ...
  1043: 'Tên nhóm đã tồn tại.', 1044: 'Sinh viên này đã thuộc một nhóm khác.', 1045: 'Đề tài đã được gán cho một nhóm khác.', 1047: 'Năm học không được để trống.', 1048: 'Năm học phải có định dạng YYYY-YYYY.',
  ...
  1063: 'Tên biểu mẫu không được để trống.', 1064: 'Tên biểu mẫu đã tồn tại.',
  1070: 'Không tìm thấy API được yêu cầu.', 1071: 'Phương thức yêu cầu không được hỗ trợ. Vui lòng khởi động lại máy chủ và thử lại.',
  1072: 'Dữ liệu không phù hợp với cấu trúc lưu trữ. Vui lòng kiểm tra lại các trường đã nhập.',
  ...
  1156: 'Ngày bảo vệ nằm ngoài thời gian của đợt bảo vệ.', 1157: 'Lịch bảo vệ bị xung đột. Vui lòng kiểm tra ngày, giờ, phòng, hội đồng hoặc đề tài.',
  1158: 'Trạng thái hiện tại của lịch không cho phép thực hiện thao tác này.',
  1161: 'Chưa thể hoàn thành lịch vì thời gian bảo vệ chưa kết thúc.',
  1159: 'Vui lòng nhập lý do thay đổi lịch bảo vệ.', 1160: 'Đề tài chưa đủ điều kiện để xếp lịch bảo vệ.',
  ...
  1106: 'Không tìm thấy hồ sơ sinh viên.', 1107: 'Không tìm thấy hồ sơ giảng viên.',
  1108: 'Nội dung nhận xét không được để trống.', 1110: 'Không tìm thấy nhận xét.',
  1123: 'Vui lòng nhập nhận xét khi chấm điểm.',
  1120: 'Không tìm thấy bản ghi điểm.',
  1122: 'Điểm phải nằm trong khoảng từ 0 đến 10.',
  1125: 'Sinh viên không thuộc nhóm của đề tài được chọn.',
  1124: 'Không thể thực hiện thao tác vì trạng thái điểm hiện tại không cho phép. Nếu điểm đã gửi hoặc đã khóa, hãy mở khóa trước khi cập nhật.',
  1111: 'Không thể sửa hoặc xóa nhận xét hệ thống này.',
  1126: 'Không tìm thấy bản phân công hướng dẫn.', 1127: 'Vui lòng chọn vai trò hướng dẫn.', 1128: 'Giảng viên này đã được phân công cho chính đề tài đang chọn; hãy chọn đề tài khác.',
  ...
  1134: 'Không tìm thấy hội đồng bảo vệ.', 1135: 'Không tìm thấy thành viên hội đồng.',
  1136: 'Vui lòng chọn vai trò trong hội đồng.', 1137: 'Giảng viên này đã có trong hội đồng.',
  1138: 'Hội đồng đã có Chủ tịch.', 1139: 'Hội đồng đã có Thư ký.',
  1140: 'Thành viên này không còn hoạt động trong hội đồng.', 1141: 'Vui lòng nhập lý do gỡ thành viên.',
  1142: 'Hội đồng không thuộc đợt bảo vệ hợp lệ.', 1143: 'Tên hội đồng không được để trống.',
  1144: 'Tên hội đồng đã tồn tại trong đợt bảo vệ này.',
  1145: 'Hội đồng chưa hợp lệ: cần tối thiểu 3 thành viên, gồm 1 Chủ tịch và 1 Thư ký.',
  1146: 'Trạng thái hiện tại của hội đồng không cho phép thực hiện thao tác này.',
  1147: 'Hội đồng đã được sử dụng nên không thể xóa.', 1148: 'Vui lòng nhập lý do ngừng hội đồng.',
  ...
  1179: 'Không tìm thấy hồ sơ ghi danh đồ án.', 1180: 'Sinh viên đã được ghi danh vào đợt bảo vệ này.',
  1181: 'Không thể chuyển hồ sơ ghi danh sang trạng thái đã chọn.',
  1182: 'Sinh viên phải thuộc một nhóm trước khi được ghi danh vào đợt bảo vệ.',
};
